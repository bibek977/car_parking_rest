...
def user():
    return User.objects.create_user(
        email="admin@gmail.com", phone="980000032", password="admin123", owner="viewer"
    )
...
def boss():
    return User.objects.create_user(
        email="boss@gmail.com", phone="9800000", password="admin123", owner="boss"
    )
...
def viewer():
    return User.objects.create_user(
        email="viewer@gmail.com", phone="980000011", password="admin123", owner="viewer"
    )
...
def car_id(viewer):
    car = Car.objects.create(
        brand="Honda", color="Blue", liscence="XYZ987", status=False, owner=viewer
    )
    return car.id
...
@pytest.fixture
def area_id():
    area = AreaName.objects.create(name="Area 67", status=False)
    return area.id
