...
class CarViewSetTest(APITestCase):
    ...
    def test_car_create(self):
        ...
        self.assertFalse(Car.objects.filter(liscence='XYZ987').exists() is None)
        self.assertEqual(Car.objects.filter(liscence="XYZ987").first().owner.email, "admin@gmail.com")
...
class ParkingViewSetTest(APITestCase):
    ...
    def test_create_parking(self):
        ...
        area_new = AreaName.objects.create(
            name="Area 54",
            status=False
        )
        park_new = {
